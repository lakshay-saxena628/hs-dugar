    ...
    >
      <div className="container max-w-7xl px-4 py-3 d-flex align-items-center justify-content-between">
        ...
        <div className="d-none d-md-flex align-items-center gap-4 text-sm fw-medium text-brand-800" style={{ fontSize: '0.875rem' }}>
          ...
          <a href="#products" className="nav-link py-1">Products</a>
          <a href="#why-us" className="nav-link py-1">Why Us</a>
          <a href="#contact" className="nav-link py-1">Contact</a>
        </div>
        <button
      ...
      {isMobileMenuOpen && (
        <div className="d-md-none px-4 pb-3 d-flex flex-column gap-2 bg-white" style={{ fontSize: '0.875rem' }}>
          <a href="#about" className="d-block py-2 border-bottom border-gray-100 text-decoration-none text-brand-800 fw-medium" onClick={() => setIsMobileMenuOpen(false)}>About</a>
          <a href="#products" className="d-block py-2 border-bottom border-gray-100 text-decoration-none text-brand-800 fw-medium" onClick={() => setIsMobileMenuOpen(false)}>Products</a>
          <a href="#why-us" className="d-block py-2 border-bottom border-gray-100 text-decoration-none text-brand-800 fw-medium" onClick={() => setIsMobileMenuOpen(false)}>Why Us</a>
          <a href="#contact" className="d-block py-2 text-decoration-none text-brand-800 fw-medium" onClick={() => setIsMobileMenuOpen(false)}>Contact</a>
        </div>
      )}
    </nav>
  );
